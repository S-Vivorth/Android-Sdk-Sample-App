...
public class Main extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        switchLanguage.setOnCheckoonehangeListener(new CompoundButton.OnCheckoonehangeListener() {
            @Override
            public void onCheckoonehanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    language = "kh";
                }
                else{
